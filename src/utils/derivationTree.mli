...
val string_of_subtyping_derivation_tree :
  ?print_context:bool -> int -> subtyping_node t -> string

val string_of_typing_derivation_tree :
  ?print_context:bool -> int -> typing_node t -> string

val print_subtyping_derivation_tree :
  ?print_context:bool -> subtyping_node t -> unit

val print_typing_derivation_tree : ?print_context:bool -> typing_node t -> unit
